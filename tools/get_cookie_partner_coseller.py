...
def run(playwright: Playwright) -> None:
    ...
    try:
        page.get_by_role("textbox", name="Email").fill("yuxiao.zhu.ext+997@1m.app")
    except:
        # Try placeholder or label
        try:
            page.locator("input[type='email'], input[name='email'], input[placeholder*='email' i]").fill("yuxiao.zhu.ext+997@1m.app")
        except:
    ...
    cookie_path = project_root / "test_case" / "UI" / "Test_Katana" / "cookie_partner_coseller_release.json"
