"""Migrated from Apifox case #8628565. Source folder: Event and ticket and redeemed/Ticket created and setting."""
# Apifox Case ID: 8628565  (traceability only — not needed to run)
NAME = "(Linda)(Venue map)T5379Verify the Additional QR codes flow work"
...
# --- step 1: 3563fc4b-af4c-4484-b728-537830cc03f4 ---
...
# --- step 2: e3040033-bc3c-4867-bb12-e3bc01f366a2 ---
...
# post: 
# post:     // 方案 A：如果要找特定 Ticket 标题（例如 "General Admission 02"）
# post:     const targetTicketTitle = "General Admission 02"; 
...
# post: });
# --- step 3: 59d406ff-a7ae-4c10-a904-6d2460d650b0 ---
...
# post: });
# --- step 4: 530b88c6-e2f0-45f6-ad2a-c42e9400b14c ---
# post[customScript]: // 1. 解析响应 JSON
# post: const responseData = pm.response.json();
# post: 
...
# post: });
# --- step 5: 50f1455b-62cc-4bac-81a1-a846635ccf16 ---
...
# post:     });
# post: });
# --- step 6: eb71fcde-3b2f-4f65-b404-38e3b58b2433 ---
# post[customScript]: // 1. 解析响应数据
# post: const responseData = pm.response.json();
# post: 
...
# post: });
# --- step 7: bcb7043d-ecc7-4063-bb97-17c3e3409863 ---
# post[customScript]: // 1. 解析响应 JSON
# post: const responseData = pm.response.json();
# post: 
# post: // 2. 状态码与业务逻辑兼容校验
...
# --- step 10: e02cff0d-13ba-4ab2-9e43-e83fa7a2283f ---
...
# --- step 11: 8a7b4674-ee9f-4181-ac43-b693037b1721 ---
...
def test_linda_venue_map_t5379verify_the_additional_qr_codes_flow_work(ctx):
    """Apifox case #8628565: Linda_Venue_map_T5379Verify_the_Additional_QR_codes_flow_work"""
    ...
    _x = next((_z for _z in _arr if _z.get('title') == "General Admission 02"), None)
