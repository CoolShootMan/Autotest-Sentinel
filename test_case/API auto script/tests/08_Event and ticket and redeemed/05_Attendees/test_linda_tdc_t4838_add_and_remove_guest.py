"""Migrated from Apifox case #8709226. Source folder: Event and ticket and redeemed/Attendees."""
# Apifox Case ID: 8709226  (traceability only — not needed to run)
NAME = "(Linda) (TDC)T4838 Add and Remove guest"
...
# --- step 1: 07459b73-7899-4b9c-a9a8-bfaaf2026e58 ---
...
# post: }
# --- step 2: 2b7d4532-70ad-4e29-9e68-62eb6682aaf4 ---
...
# post: });
# --- step 3: 0351a1c0-d96d-497c-81be-8c536b182793 ---
...
def test_linda_tdc_t4838_add_and_remove_guest(ctx):
    """Apifox case #8709226: Linda_TDC_T4838_Add_and_Remove_guest"""
    ...
    _target1 = next((it for it in _items1 if it.get('platform') == "TDC"), None)
