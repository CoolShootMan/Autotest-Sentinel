"""Migrated from Apifox case #8600648. Source folder: Event and ticket and redeemed/Reveal address."""
# Apifox Case ID: 8600648  (traceability only — not needed to run)
NAME = "(Lury)Verify reveal address to buyer after at time check on order confirmation page"
...
def test_lury_verify_reveal_address_to_buyer_after_at_time_check_on_order_confirmation_page(ctx):
    """Apifox case #8600648: Lury_Verify_reveal_address_to_buyer_after_at_time_check_on_order_confirmation_pa"""
    ...
    # step 3: buy now
    _resp3 = ctx.api.orders.checkout_express(body='{\n    "items": [\n        {\n            "quantity": 1,\n            "promoterProductVariantId": "b8676fea-14ae-464a-9d02-646a6d094782",\n            "price": 0,\n            "postId": "a63c830a-f9d5-4c2f-9864-1fbd7a534138",\n            "selected": true,\n            "customFields": []\n        }\n    ],\n    "fbAdParams": {\n        "eventID": "0655fcea-4559-42bb-b561-54e81b4c02c4",\n        "pixelId": [\n            "268933192948110"\n        ],\n        "fbBrowserId": "fb.1.1768467567031.92506180232323161",\n        "externalId": "154873ad-8fbe-4f69-bdf0-e11205c4eab8",\n        "eventSourceUrl": "https://release.pear.us/mcc/post/lury-event-reveal-address-to-buyer-after-at-automation-testing-0806"\n    },\n    "subdomainVanityUrl": ""\n}')
