"""Migrated from Apifox case #8600639. Source folder: Event and ticket and redeemed/Reveal address."""
# Apifox Case ID: 8600639  (traceability only — not needed to run)
NAME = "(Lury)Verify reveal address after at time check on order confirmation page"
...
def test_lury_verify_reveal_address_after_at_time_check_on_order_confirmation_page(ctx):
    """Apifox case #8600639: Lury_Verify_reveal_address_after_at_time_check_on_order_confirmation_page"""
    ...
    # step 3: buy now
    _resp3 = ctx.api.orders.checkout_express(body='{\n    "items": [\n        {\n            "quantity": 1,\n            "promoterProductVariantId": "da74900a-b8d4-49d8-adb8-7120e61b6f0a",\n            "price": 0,\n            "postId": "3ec5d8b2-ec0f-419b-afce-1a65f88d7f0f",\n            "selected": true,\n            "customFields": []\n        }\n    ],\n    "fbAdParams": {\n        "eventID": "590ad00d-c731-4ad3-aaaf-803a90781524",\n        "pixelId": [\n            "268933192948110"\n        ],\n        "fbBrowserId": "fb.1.1768467567031.92506180232323161",\n        "externalId": "154873ad-8fbe-4f69-bdf0-e11205c4eab8",\n        "eventSourceUrl": "https://release.pear.us/mcc/post/lury-event-reveal-address-after-at-automation-testing-0806"\n    },\n    "subdomainVanityUrl": ""\n}')
