"""Migrated from Apifox case #8602151. Source folder: Event and ticket and redeemed/Reveal address."""
# Apifox Case ID: 8602151  (traceability only — not needed to run)
NAME = "(Lury)Resell Verify reveal address after at time check on order confirmation page"
...
# post:         if (line_item["merchantProductId"] === "be105de4-2c8b-4063-91c7-cf417ed7e29b"){
...
# post:             pm.expect(line_item["extraInfo"]["event"]).to.eql("Lury event reveal address after at automation testing 0806");
# post:             pm.expect(line_item["extraInfo"]["venue"]).to.eql("reveal address after at 2026-8-6");
# post:         }
# post:     }
# post: 
# post: });
...
def test_lury_resell_verify_reveal_address_after_at_time_check_on_order_confirmation_page(ctx):
    """Apifox case #8602151: Lury_Resell_Verify_reveal_address_after_at_time_check_on_order_confirmation_page"""
    ...
    # step 3: buy now
    _resp3 = ctx.api.orders.checkout_express(body='{\n    "items": [\n        {\n            "quantity": 1,\n            "promoterProductVariantId": "7d28ad45-7df5-4d55-add4-18daedd2ed92",\n            "price": 0,\n            "postId": "dcddc4de-55cf-4b85-be96-4882cbb95d88",\n            "selected": true,\n            "customFields": []\n        }\n    ],\n    "fbAdParams": {\n        "eventID": "1e1d173d-ec33-4c51-94a6-e884dbcd4239",\n        "pixelId": [\n            "268933192948110"\n        ],\n        "fbBrowserId": "fb.1.1768467567031.92506180232323161",\n        "externalId": "154873ad-8fbe-4f69-bdf0-e11205c4eab8",\n        "eventSourceUrl": "https://release.pear.us/auto-merchant/post/lury-event-reveal-address-after-at-automation-testing-0806"\n    },\n    "subdomainVanityUrl": ""\n}')
