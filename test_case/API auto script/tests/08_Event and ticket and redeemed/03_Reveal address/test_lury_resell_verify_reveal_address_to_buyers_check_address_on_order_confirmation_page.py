"""Migrated from Apifox case #8602138. Source folder: Event and ticket and redeemed/Reveal address."""
# Apifox Case ID: 8602138  (traceability only — not needed to run)
NAME = "(Lury)Resell Verify reveal address to buyers check address on order confirmation page"
...
def test_lury_resell_verify_reveal_address_to_buyers_check_address_on_order_confirmation_page(ctx):
    """Apifox case #8602138: Lury_Resell_Verify_reveal_address_to_buyers_check_address_on_order_confirmation_"""
    ...
    # step 3: buy now
    _resp3 = ctx.api.orders.checkout_express(body='{\n    "items": [\n        {\n            "quantity": 1,\n            "promoterProductVariantId": "7744ac31-3baf-4c6f-bf69-86171ecb8c9c",\n            "price": 0,\n            "postId": "231b8bcf-2a53-4583-a2e9-e60e4bf24bc7",\n            "selected": true,\n            "customFields": []\n        }\n    ],\n    "fbAdParams": {\n        "eventID": "35061890-9680-4590-a0e1-a51a3b1ff0fb",\n        "pixelId": [\n            "268933192948110"\n        ],\n        "fbBrowserId": "fb.1.1768467567031.92506180232323161",\n        "externalId": "154873ad-8fbe-4f69-bdf0-e11205c4eab8",\n        "eventSourceUrl": "https://release.pear.us/auto-merchant/post/lury-event-dont-reveal-address-automation-testing-0806"\n    },\n    "subdomainVanityUrl": ""\n}')
