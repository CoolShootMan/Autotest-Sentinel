"""Migrated from Apifox case #8602154. Source folder: Event and ticket and redeemed/Reveal address."""
# Apifox Case ID: 8602154  (traceability only — not needed to run)
NAME = "(Lury)Resell Verify reveal address to buyer after at time check on order confirmation page"
...
# post:         if (line_item["merchantProductId"] === "14c159fd-6f1a-45c5-9c95-69a5c06473d6"){
...
# post:             pm.expect(line_item["extraInfo"]["event"]).to.eql("Lury event reveal address to buyer after at automation testing 0806");
# post:             pm.expect(line_item["extraInfo"]["venue"]).to.eql("reveal address to buyers after at 2026-8-6");
# post:         }
# post:     }
# post: 
# post: });
...
def test_lury_resell_verify_reveal_address_to_buyer_after_at_time_check_on_order_confirmation_page(ctx):
    """Apifox case #8602154: Lury_Resell_Verify_reveal_address_to_buyer_after_at_time_check_on_order_confirma"""
    ...
    # step 3: buy now
    _resp3 = ctx.api.orders.checkout_express(body='{\n    "items": [\n        {\n            "quantity": 1,\n            "promoterProductVariantId": "7a97e9af-fa32-450d-8c08-3a3f2f084cf9",\n            "price": 0,\n            "postId": "59fa75c9-1924-4def-a579-d2cb72303664",\n            "selected": true,\n            "customFields": []\n        }\n    ],\n    "fbAdParams": {\n        "eventID": "f9ebdcd2-2002-4231-a4b3-91ef9087164f",\n        "pixelId": [\n            "268933192948110"\n        ],\n        "fbBrowserId": "fb.1.1768467567031.92506180232323161",\n        "externalId": "154873ad-8fbe-4f69-bdf0-e11205c4eab8",\n        "eventSourceUrl": "https://release.pear.us/auto-merchant/post/lury-event-reveal-address-to-buyer-after-at-automation-testing-0806"\n    },\n    "subdomainVanityUrl": ""\n}')
