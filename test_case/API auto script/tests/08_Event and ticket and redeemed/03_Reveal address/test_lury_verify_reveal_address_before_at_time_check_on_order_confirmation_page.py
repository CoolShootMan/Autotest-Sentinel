"""Migrated from Apifox case #8601809. Source folder: Event and ticket and redeemed/Reveal address."""
# Apifox Case ID: 8601809  (traceability only — not needed to run)
NAME = "(Lury)Verify reveal address before at time check on order confirmation page"
...
def test_lury_verify_reveal_address_before_at_time_check_on_order_confirmation_page(ctx):
    """Apifox case #8601809: Lury_Verify_reveal_address_before_at_time_check_on_order_confirmation_page"""
    ...
    # step 3: buy now
    _resp3 = ctx.api.orders.checkout_express(body='{\n    "items": [\n        {\n            "quantity": 1,\n            "promoterProductVariantId": "9b5d59c5-e2f5-4278-bd2c-1e76bb5f6654",\n            "price": 0,\n            "postId": "322d0753-5b9a-4711-9b6e-916d0e331961",\n            "selected": true,\n            "customFields": []\n        }\n    ],\n    "fbAdParams": {\n        "eventID": "8003d30a-1b63-4c17-8115-999035c2c42d",\n        "pixelId": [\n            "268933192948110"\n        ],\n        "fbBrowserId": "fb.1.1768467567031.92506180232323161",\n        "externalId": "154873ad-8fbe-4f69-bdf0-e11205c4eab8",\n        "eventSourceUrl": "https://release.pear.us/mcc/post/lury-event-reveal-address-before-at-automation-testing-0806"\n    },\n    "subdomainVanityUrl": ""\n}')
