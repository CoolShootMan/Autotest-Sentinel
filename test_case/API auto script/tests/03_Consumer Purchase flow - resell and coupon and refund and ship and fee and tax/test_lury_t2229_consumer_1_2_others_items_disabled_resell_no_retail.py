"""Migrated from Apifox case #7542684. Source folder: Consumer Purchase flow - resell and coupon and refund and ship and fee and tax."""
# Apifox Case ID: 7542684  (traceability only — not needed to run)
NAME = "_Consumer_1-2_Others_items_disabled_resell_no_retail"
...
# pre: var promoter_transaction_fee = Number((10/100 * transaction_fee_item_level).toFixed(2));
...
# post:     pm.response.to.have.status(201);
# post:     var res = JSON.parse(responseBody);
# post:     pm.expect(res['data']['totalTopay']).to.eql(113.65);
# post: });
# --- step 5: Login - P1 ---
...
def test_lury_t2229_consumer_1_2_others_items_disabled_resell_no_retail(ctx):
    """Apifox case #7542684: Lury_T2229_Consumer_1_2_Others_items_disabled_resell_no_retail"""
